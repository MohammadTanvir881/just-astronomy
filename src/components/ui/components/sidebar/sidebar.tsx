...
export default function DashboardPage() {
  return (
    ...
    {/* Mobile Header - Now properly sticky on mobile */}
    <header className="lg:hidden bg-slate-800 p-4 flex items-center justify-between fixed top-0 left-0 right-0 z-50 border-b border-slate-700">
    ...
    {/* Add padding to content to account for fixed header on mobile */}
    <div className="pt-16 lg:pt-0 flex">
      ...
      <main className="flex-1">
        {/* Content goes here - it will now appear below the fixed header on mobile */}
      </main>
    </div>
  </div>
  );
