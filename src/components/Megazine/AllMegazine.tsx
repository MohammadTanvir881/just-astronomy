...
function MagazinesTable({ magazines }: { magazines: Magazine[] }) {
  console.log("Magazines:", magazines);

  const handleEdit = (magazine: Magazine) => {
    // Add your edit logic here
    console.log("Edit magazine:", magazine);
  };

  const handleDelete = (magazine: Magazine) => {
    // Add your delete logic here
    console.log("Delete magazine:", magazine);
  };
                ...
                >
                  <TableCell>
                    <div className="relative h-16 w-16 rounded-md overflow-hidden">
                      <img
                        src={
                          magazine.magazineImage || "/placeholder-magazine.jpg"
                        }
                        alt={magazine.title}
                        width={64}
                        height={64}
                  ...
                  <TableCell>
                    <div className="flex gap-2 justify-end">
                      <Button
                        ...
                        onClick={() => handleDownload(magazine.downloadLink)}
                        title="Download"
                      >
